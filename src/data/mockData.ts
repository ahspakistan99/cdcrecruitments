...
export const DEPARTMENTS: DepartmentInfo[] = [
  ...
  },
  {
    ...
    description: '24/7 Emergency trauma care, ICU/CCU, Inpatient wards, and Specialized Outpatient Consultations at Capital Care International Hospital (CCIH) Islamabad.'
  },
  {
    id: 'hospital_nursing',
  ...
  },
  {
    ...
    description: 'Hospital human capital management, medical staff credentialing, onboarding, training, and employee welfare at Capital Care International Hospital (CCIH).'
  },
  {
    id: 'accounts_finance',
...
export const INITIAL_JOB_POSTS: JobPost[] = [
  ...
  },
  {
    ...
    openings: 4,
    deadline: '2026-10-05',
    description: 'Frontline medical management of acute medical and trauma patients arriving at Capital Care International Hospital (CCIH) Emergency and monitoring admitted critical patients in ICU/HDU.',
    responsibilities: [
  ...
  },
  {
    ...
    employmentType: 'Full-time',
    location: 'Capital Care International Hospital (CCIH) Executive Wing, Islamabad',
    minExperienceYears: 2,
  ...
  },
  {
    ...
    employmentType: 'Full-time',
    location: 'Capital Care International Hospital (CCIH) Finance Wing, Islamabad',
    minExperienceYears: 3,
  ...
  },
  {
    ...
    employmentType: 'Full-time',
    location: 'Capital Care International Hospital (CCIH) Main Lobby, Islamabad',
    minExperienceYears: 1,
...
export const INITIAL_APPLICATIONS: JobApplication[] = [
  ...
  },
  {
    ...
    interviewDetails: {
      ...
      venue: 'Executive Meeting Room, Capital Care International Hospital (CCIH) Islamabad',
  ...
  },
  {
    ...
    coverLetter: 'Eager to contribute to Capital Care International Hospital (CCIH) Emergency care. Trained in BLS, ACLS, rapid trauma triage, ultrasound-guided venous access, and endotracheal intubations.',
    hasCnicCopy: true,
    hasDegreeCopy: true,
    hasLicenseCopy: true,
    status: 'shortlisted',
